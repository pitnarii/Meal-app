...
def get_meal_plan(duration, **kwargs):
    ...
    # the code below can be better. For now, it returns a json object which
    # contains a dictionary with days as keys and a list of 
    # breakfast/lunch/dinner as value
    meal_dict = {}
    for day in days:
        meal_plan = []
        breakfast = {
